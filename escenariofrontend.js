...
xhr.open('POST', 'http://localhost:8080/api/guardarescenario');
  ...
  return new Promise(function(resolve, reject) {
    // Do the usual XHR stuff
      ...
      try {
               ...
               var xhr = new XMLHttpRequest();
xhr.open('POST', 'http://loaclhost:8080/api/modificarescenario');
xhr.setRequestHeader('Content-Type', 'application/json');
xhr.onload = function() {
    if (xhr.status === 200) {
        resolve(JSON.parse(xhr.responseText));
  ...
  return new Promise(function(resolve, reject) {
    // Do the usual XHR stuff
      ...
      try {
               ...
               var xhr = new XMLHttpRequest();
xhr.open('POST', 'http://localhost:8080/api/Eliminarescenario');
xhr.setRequestHeader('Content-Type', 'application/json');
xhr.onload = function() {
    if (xhr.status === 200) {
        resolve(JSON.parse(xhr.responseText));
